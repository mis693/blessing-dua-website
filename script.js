document.addEventListener('DOMContentLoaded', () => {
    ...
    6: {
        text: "Bless [name] with a heart overflowing with profound gratitude for Your countless favors, and a life truly full of Your blessings. May every day bring new opportunities for growth, joy, and spiritual fulfillment. Protect them always and keep them under Your loving care. Ameen.",
        gif: "public/dua6.gif"
    }
};
